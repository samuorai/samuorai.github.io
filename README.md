...
<head>
  ...
  <title>Wael Osama iportfolio</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/favicon5.jpg" rel="icon">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="#contact" class="nav-link scrollto"><i class="bx bx-envelope"></i> <span>Contact</span></a></li>
           <li><a href="#Projects" class="nav-link scrollto"><i class="bx bx-data"></i> <span>Projects</span></a></li>
        </ul>
        </nav><!-- .nav-menu -->
    </div>
    <div id="button1">
      <a href="resume.pdf" type="submit" class="btn btn-outline-primary">Download CV</a>
    </div>
    </header><!-- End Header -->
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="progress">
              <span class="skill">Embedded C <i class="val">100%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">Debugging <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="progress">
              <span class="skill">Scripting <i class="val">60%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">VCS <i class="val">95%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">
                </div>
              </div>
            ...
            <div class="progress">
              <span class="skill">Assembly <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item">
              ...
              <ul>
                ...
                <li>ntegrated various WP plugins like Woocommerce, MonsterInsights and more</li>
                <li>Creating our designs of websites and background images. </li>
              </ul>
            </div>
            <div class="resume-item">
              <h4>Projects</h4>
              <h5>2019 - Present</h5>
              <p><em>Projects on Github </em></p>
              <ul>
                <li>The book of heart (Website blog)</li>
                <li>Tic-Tac-Toe ( Project on simple Javascript game)</li>
                <li>E-commerce website on wordpress. </li>
                <li>College website ( frontend on HTML,CSS,BOOTSTRAP,TAILWIND</li>
                <li>Portfolio (frontend on Recat)</li>
                <li>LMS website on wordpress</li>
                <li>Swiggy website ( Frontend on HTML,CSS)</li>
            </div>
          </div>
        </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>I am currently looking for new opportunities, my inbox is always open. Whether you have a question or just
            want to say hi, I will try my best to get back to you!</p>
        </div>
...
<div class="footer">
 <footer>&copy;2023 Wael Osama r</footer>
</div
